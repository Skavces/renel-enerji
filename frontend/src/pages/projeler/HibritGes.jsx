...
export default function HibritGes() {
  ...
  return (
    <>
      <PageHeader title="10,2 kW Hibrit GES Sistemi" parent={{ label: 'Projelerimiz', to: '/projelerimiz' }} />
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                RenEl Enerji Mühendislik olarak, yenilenebilir enerjiye verdiğimiz değeri bir adım daha ileriye taşıdık.
                10,2 kW kapasiteli hibrit güneş enerji sistemimizi başarıyla devreye aldık.
              </p>
            </div>
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-4">Sistem Avantajları</h2>
              <ul className="space-y-3">
                {benefits.map(b => (
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="bg-white rounded-xl border border-gray-100 p-4 text-center">
                <p className="text-[#448834] font-bold text-2xl font-['Rajdhani']">10,2 kW</p>
                <p className="text-xs text-gray-400 font-medium mt-1">Kurulu Güç</p>
              </div>
              <div className="bg-white rounded-xl border border-gray-100 p-4 text-center">
                <p className="text-[#448834] font-bold text-2xl font-['Rajdhani']">16</p>
                <p className="text-xs text-gray-400 font-medium mt-1">Panel</p>
              </div>
              <div className="bg-white rounded-xl border border-gray-100 p-4 text-center">
                <p className="text-[#448834] font-bold text-2xl font-['Rajdhani']">15,3 kWh</p>
