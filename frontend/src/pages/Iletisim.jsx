            ...
            <div className="flex flex-col gap-4 h-full">
              ...
              <div className="grid grid-cols-3 gap-2 mt-auto">
                <a href="https://wa.me/905543796004?text=Merhaba,%20güneş%20enerjisi%20hakkında%20bilgi%20almak%20istiyorum."
                  target="_blank" rel="noopener noreferrer"
                  className="flex items-center justify-center gap-1.5 bg-[#25d366] hover:bg-[#1ebe5d] text-white font-bold py-3 rounded-xl transition-colors text-xs sm:text-sm"
                >
                ...
                <a href="https://www.instagram.com/renelenerjimuhendislik/"
                  target="_blank" rel="noopener noreferrer"
                  className="flex items-center justify-center gap-1.5 text-white font-bold py-3 rounded-xl transition-opacity hover:opacity-90 text-xs sm:text-sm"
                ...
                <a href="https://www.facebook.com/p/RenEl-Enerji-M%C3%BChendislik-61578891790441/"
                  target="_blank" rel="noopener noreferrer"
                  className="flex items-center justify-center gap-1.5 bg-[#1877f2] hover:bg-[#166fe5] text-white font-bold py-3 rounded-xl transition-colors text-xs sm:text-sm"
                >
                  <svg viewBox="0 0 24 24" width="15" height="15" fill="currentColor" className="shrink-0">
