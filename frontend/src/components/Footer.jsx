        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="mb-4 -ml-3">
              <img src="/renel-enerji_logo.svg" alt="RenEl Enerji Mühendislik" className="h-16 w-auto brightness-0 invert" width="161" height="64" loading="lazy" />
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href={`https://wa.me/${WA_NUMBER}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-sm hover:text-[#f5ce31] transition-colors">
