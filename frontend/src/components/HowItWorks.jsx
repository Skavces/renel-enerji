...
export default function HowItWorks() {
  return (
    <section className="py-24 bg-white relative overflow-hidden">
      <img src="/nasil-calisiriz.webp" alt="" width="1920" height="600" className="absolute inset-0 w-full h-full object-cover pointer-events-none select-none z-0" loading="lazy" />
            ...
            <div key={s.num} className={`flex flex-col text-center ${i === 0 || i === 3 ? 'md:mt-16' : ''}`}>
              ...
              <div className="relative mb-5 w-3/4 mx-auto pt-3 pl-3">
                <div className="aspect-square overflow-hidden rounded-xl">
                  <img
                    src={s.img}
                    srcSet={`${s.img.replace('.webp', '-320w.webp')} 320w, ${s.img.replace('.webp', '-640w.webp')} 640w`}
